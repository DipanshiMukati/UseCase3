...
public class TransportationCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		}else if (!DataValidator.isTooLong(request.getParameter("description"), 200)) {
			request.setAttribute("description", "description contain 200 characters");
			pass = false;
		} else if (!DataValidator.isStringLengthValid(request.getParameter("description"), 10)) {
			request.setAttribute("description", "description  must be at least 10 characters long.");
			pass = false;
			return pass;
