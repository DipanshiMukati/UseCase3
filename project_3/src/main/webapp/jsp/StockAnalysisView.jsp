...
<title>StockAnalysisList view</title>
							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									...
									<input type="text" name="stockSymbol" placeholder="Enter stockSymbol"
											class="form-control"
											rows="5" cols="5" value="<%=DataUtility.getStringData(dto.getStockSymbol())%>">	

									</div>
								</div>

								<font color="red" class="pl-sm-5" id="stockSymbolError">
									<%=ServletUtility.getErrorMessage("stockSymbol", request)%></font></br> 
									

	
								<span class="pl-sm-5"><b>analysisType</b> <span style="color: red;">*</span></span></br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
											<div class="input-group-text">
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										...
										value="<%=StockAnalysisCtl.OP_CANCEL%>">
